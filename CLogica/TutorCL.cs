...
namespace ConsultorioPsicopedagogico.CLogica
{
    internal class TutorCL
    {
        ...
        {
            Tutor_CD datos = new Tutor_CD();
            return datos.TablaBajaTutores();
        }

        public void ReactivarTutor(TutorCL tutor)
        {
            Tutor_CD datos = new Tutor_CD();
            datos.ReactivarTutor(PasarDatos(tutor));
        }
